...
class Order_Service_PaymentType extends MF_Service_ServiceAbstract {
    ...
    public function getAllPaymentType($hydrationMode = Doctrine_Core::HYDRATE_RECORD) {
        $q = $this->paymentTypeTable->getPaymentTypeQuery();
        return $q->execute(array(), $hydrationMode);
    }
    
    public function getTargetPaymentTypeRadioOptions() {
        $items = $this->getAllPaymentType();
        $result = array();
