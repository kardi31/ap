 ...
 */
class Faq_Form_Faq extends Admin_Form {
...
//        
//        $sponsored = $this->createElement('checkbox', 'sponsored');
//        $sponsored->setLabel('Faq sponsored');
//        $sponsored->setDecorators(self::$checkgroupDecorators);
//        $sponsored->setAttrib('class', 'span8');
//        
