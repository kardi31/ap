 ...
 */
abstract class Faq_Model_Doctrine_BaseFaq extends Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('faq_faq');
        ...
        $this->hasColumn('sponsored', 'boolean', null, array(
             'type' => 'boolean',
             'default' => 0,
             ));
    ...
    public function setUp()
    {
        ...
        $this->hasMany('Faq_Model_Doctrine_FaqTranslation as Translation', array(
             'local' => 'id',
             'foreign' => 'id'));
