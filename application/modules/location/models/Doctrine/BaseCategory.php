...
/**
 * Location_Model_Doctrine_BaseCategory
 * 
 ...
 */
abstract class Location_Model_Doctrine_BaseCategory extends Doctrine_Record
{
    ...
    {
        parent::setUp();
        $this->hasMany('Location_Model_Doctrine_Location as Locations', array(
             'local' => 'id',
             'foreign' => 'category_id'));

        $this->hasMany('Location_Model_Doctrine_CategoryTranslation as Translation', array(
             'local' => 'id',
             'foreign' => 'id'));
