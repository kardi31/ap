...
/**
 * Attachment_Model_Doctrine_BaseAttachment
 * 
 ...
 */
abstract class Attachment_Model_Doctrine_BaseAttachment extends Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('attachment_attachment');
    ...
    {
        parent::setUp();
        $this->hasMany('Attachment_Model_Doctrine_AttachmentTranslation as Translation', array(
             'local' => 'id',
             'foreign' => 'id'));
