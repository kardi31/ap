...
/**
 * Tournament_Service_Shooter
 *
@author Andrzej Wilczyński <and.wilczynski@gmail.com>
 */
class Tournament_Service_Shooter extends MF_Service_ServiceAbstract {
    
    protected $shooterTable;
    
    public function init() {
        $this->shooterTable = Doctrine_Core::getTable('Tournament_Model_Doctrine_Shooter');
        parent::init();
    }
    ...
    public function getMatchShooters($match_id,$hydrationMode = Doctrine_Core::HYDRATE_ARRAY)
      {
           ...
           return $result;
              ...
              public function getShooters($tournament_id,$hydrationMode = Doctrine_Core::HYDRATE_RECORD)
              {
                  $q = $this->shooterTable->createQuery('s');
                  $q->leftJoin('s.Player p');
                  $q->leftJoin('p.Team t');
